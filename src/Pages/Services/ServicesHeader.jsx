...
import { STATUS_TABS } from "./servicesConstants";
import { useTranslation } from "react-i18next";
import { HiOutlineSquaresPlus } from "react-icons/hi2";

const ServicesHeader = ({ status, onStatusChange, totalCount }) => {
                ...
                <Stack gap={4}>
                    <Group gap="xs">
                        <div className="p-2 bg-main/10 rounded-lg">
                            <HiOutlineSquaresPlus size={24} className="text-main" />
                        </div>
